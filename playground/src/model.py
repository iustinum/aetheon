...
class GPT():
    ...
    systemContent = "Your are an assistant analyzing a codebase. "
    query = "Produce a document in markdown syntax. This document should consist of all the important functions as well as a corresponding inline documentation consisting of description of the function's use case, descriptions of any function arguments and return values, and any side effects that may be caused from calling the function. "
    contextPrefix = "Here is the context for the codebase I want you to analyze: "
