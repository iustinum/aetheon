<div class="page h-94vh md:h-90vh md:mt-8">
	...
	<p>
		Well-written documentation and following code style conventions are key to efficient
		collaboration. We automate both of these with a static analyzer powered by the recent 
